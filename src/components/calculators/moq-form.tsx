    ...
    <Form {...form}>
      <form className="space-y-6">
        <div className="space-y-4">
          {/* Header desktop */}
          <div className="hidden md:grid grid-cols-[1fr_1fr_1fr_40px] gap-x-4 gap-y-2 text-sm font-medium text-muted-foreground px-2">
            <span>Length (mm)</span>
            <span>Width (mm)</span>
          ...
          <div className="space-y-4 md:space-y-2">
            {fields.map((field, index) => {
              ...
              return (
                <div key={field.id} className="relative grid grid-cols-2 md:grid-cols-[1fr_1fr_1fr_40px] gap-x-3 gap-y-3 md:gap-y-0 md:gap-x-4 items-start bg-accent/20 dark:bg-accent/10 p-4 md:p-2 rounded-lg border md:border-none border-border/50">
                  ...
                  <div className="col-span-2 md:col-span-1 h-auto md:h-10 flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center font-mono text-foreground bg-primary/5 md:bg-transparent p-2 md:p-0 rounded md:rounded-none">
                    ...
                    <span className="text-base md:text-lg font-bold text-primary md:text-foreground">
        ...
        <Button type="button" variant="outline" className="w-full md:w-auto" size="sm" onClick={() => append({ panjang: 0, lebar: 0 })}>
